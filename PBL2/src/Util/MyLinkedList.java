...
public class MyLinkedList implements IList{
    ...
    */
    public void addMeio(int pos, Comparable obj){
        if(pos == 0)
    ...
    */
    public Comparable removeInicio(){
        Link aux = first;
        first = first.getNext();
        this.tamanho--;
    ...
    public Comparable removeFim(){
        ...
        {  if(tamanho == 1)
            ...
            {   Link penult = getCelula(tamanho - 1);
                ...
                return (Comparable) penult.getObj();
            }
        }
        return null;
    }                    
    ...
    */
    ...
    /**
    * Método que cria um iterator a partir da classe MyIterator 
    * @return itera iterator criado.
    */
    @Override
    public Iterator iterator() {                  
        MyIterator itera = new MyIterator(this.first);
        return itera;
    }    
    
    /**
     * Sub-Classe privada da lista encadeada que implementa os métodos de Iterator
     */
    private class MyIterator implements Iterator {
        ...
        /**
        * Construtor do Iterator. Recebe a refêrencia de topo da lista para ser o topo do iterador
        * @param topo
        */
        public MyIterator(Link topo){
            this.primeiro = topo;
        }
        
        /**
         * Método que testa se lista tem um próximo elemento. 
         * @return 'true' se tiver, 'false' caso contrário.
         */
        @Override
        public boolean hasNext() {
            return getCelula(num) != null;
        }
 
        /**
         * Método retorna o objeto atual que o iterator pousa sobre. 
         * @return o objeto que o iterator aponta.
         */
        @Override
        public Object next() {
            if(!this.hasNext())

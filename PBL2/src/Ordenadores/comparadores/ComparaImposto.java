...
public class ComparaImposto implements Comparable, Comparator {
    private Produto prod;
    
    /**
     * Construtor da classe ComparaImposto. Instancia um objeto desta classe que
     * implementa a interface Comparable e Comparator.
     * @see Comparator
     * @see Comparable
     */
    public ComparaImposto(){        
    }
    ...
    {   if(prod.getImposto() - ((Produto)obj).getImposto() < 0 )
            {   return -1;  }
       
        else if(prod.getImposto() - ((Produto)obj).getImposto() > 0 )
            {   return 1;    }
    ...
    {   if( ((Produto)o1).getImposto() - ((Produto)o2).getImposto() < 0 )
            {   return -1;  }
       
        else if( ((Produto)o1).getImposto() - ((Produto)o2).getImposto() > 0 )
            {   return 1;    }

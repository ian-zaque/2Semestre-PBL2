...
import Ordenadores.comparadores.ComparaFrete;
import Util.MyLinkedList;
import Util.Swap;

public class OrdenaFreteDec {
    private ComparaFrete comparator;
    
    /**
     * Construtor da classe OrdenaFreteDec. Instancia um objeto da classe ComparaFrete
     * que será usado no método de ordenação.
     */
    public OrdenaFreteDec()
    { comparator = new ComparaFrete();   }

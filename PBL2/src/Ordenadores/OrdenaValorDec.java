...
import Util.Swap;
import Ordenadores.comparadores.ComparaValor;
import Model.Produto;
import Util.MyLinkedList;

public class OrdenaValorDec {
    private ComparaValor comparator;
    
    /**
     * Construtor da classe OrdenaValorDec. Instancia um objeto da classe ComparaValor
     * que será usado no método de ordenação.
     */
    public OrdenaValorDec()
    { comparator = new ComparaValor();   }

...
import Ordenadores.comparadores.ComparaPeso;
import Util.Swap;
import Util.MyLinkedList;
import Model.Produto;

public class OrdenaPesoDec {
    private ComparaPeso comparator;
    
    /**
     * Construtor da classe OrdenaPesoDec. Instancia um objeto da classe ComparaPeso
     * que será usado no método de ordenação.
     */
    public OrdenaPesoDec()
    {   comparator = new ComparaPeso();   }

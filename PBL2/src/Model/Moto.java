...
public class Moto extends Carro {
    ...
    /**
     * Construtor da classe Barco que herda da classe Carro.
     ...
     * @see Carro
     */
    public Moto(long codigo, double valorItem, double imposto, double frete, double pesoItem, LocalDate dataChegada, int anoFabric, String modelo, String marca, String combust, String motor) 
    {   super(codigo, valorItem, imposto, frete, pesoItem, dataChegada, anoFabric, modelo, marca, combust);
        this.motor = motor;
    }               
}